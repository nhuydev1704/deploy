...
import { getDataNotoken } from '../../apis/fetchData';
...
function DashBoard() {
    ...
    useEffect(() => {
        ...
        try {
            ...
            getData('https://shopcnpm.herokuapp.com/api/total');
            getDataProduct('https://shopcnpm.herokuapp.com/api/products?limit=99');
            getDataUser('https://shopcnpm.herokuapp.com/user/allInfor');
        } catch (error) {
            console.log(error)
        }
    }, []);
            ...
            <Row style={{ marginTop: 16 }}>
                <TabsCustom defaultActiveKey={current} onChange={handleClick} theme2={theme.toString()} >
                                ...
                                <Row gutter={[16, 16]}>
                                    <Col style={{ minHeight: '231px' }} xl={12} lg={24} md={24} sm={24} xs={24}>
                                        <Row gutter={[16, 16]}>
                                            <Col xl={12}>
                                                <CardCustom
                                                    style={{ minHeight: '224px', boxShadow: 'rgba(0, 0, 0, 0.25) 0px 0.0625em 0.0625em, rgba(0, 0, 0, 0.25) 0px 0.125em 0.5em, rgba(255, 255, 255, 0.1) 0px 0px 0px 1px inset' }}
                                                    theme2={theme.toString()}
                                                    size="small"
                                                >
                                                    <DashboardPie2 typePie={1} dataPie2={dataUserPie1 && dataUserPie1} />
                                            ...
                                            <Col xl={12}>
                                                <CardCustom
                                                    ...
                                                    size="small"
                                                >
                                                    <DashboardPie2 typePie={2} dataPie2={dataUserPie2 && dataUserPie2} />
                                            ...
                                            <Col xl={12}>
                                                <CardCustom
                                                    ...
                                                    size="small"
                                                >
                                                    <DashboardPie2 typePie={3} dataPie2={dataUserPie3 && dataUserPie3} />
                    ...
                    <TabPane tab="Đơn hàng" key="2">
                        <TabOrderList dataPayment={dataPayment && dataPayment.length > 0 && dataPayment} theme={theme} />
                    </TabPane>
                </TabsCustom>
            </Row>
